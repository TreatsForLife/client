...
var Consts = {
  debug: true,
  api_root: (Utils.isLocal && false) ? 'http://localhost:3000/' : 'http://treatsforlife-api.herokuapp.com/',//'http://tfl.bchmn.com/',//'http://treatsforlife-api.herokuapp.com/'
  client_root: (true || Utils.isLocal) ? 'http://localhost:9000/' : 'http://app.treatsforlife.org/',
